      ...
      <div className="mt-20">
        <div className="flex">
         ...
         <div className="flex flex-col border-gray-300 gap-4 border px-6 py-6 text-sm text-gray-500">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet ipsam sequi reprehenderit ducimus error sapiente assumenda libero expedita, rerum explicabo modi, nam officia hic numquam laborum odio architecto et vel.</p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis, eaque rerum repellat ullam facere laborum amet esse, neque culpa autem fugiat magni velit expedita minus facilis earum quibusdam explicabo magnam.</p>
         </div>
      </div>
